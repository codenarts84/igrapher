...
const MobileWarning = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-full p-4 text-center text-white bg-black/50 backdrop-blur-[30px]'>
