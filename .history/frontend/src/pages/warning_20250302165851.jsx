...
const MobileWarning = () => {
  ...
  return (
    <div className='fixed top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-full p-4 text-center text-white bg-black/30 backdrop-blur-[10px]'>
      ...
      <a
        href='/'
        className={`my-[10px]  h-[60px] bg-sky-900 hover:bg-sky-700 hover:w-[70%] flex justify-center items-center animate__animated animate__fadeInUp rounded-full text-3xl   px-10 py-6
