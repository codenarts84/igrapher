              ...
              <motion.div className='inline-flex items-center justify-center'>
                            ...
                            <motion.div
                              ...
                              className={`cursor-pointer ${
                                hasEntered === 0
                                  ...
                                  : ''
                              } flex  duration-50 justify-center items-center ${DockerButtonSize} ${
                                tool.name === 'Query'
                ...
                <motion.div
                  ...
                  className={`${
                    hasEntered === 0
                      ? 'animate__animated animate__fadeInUp'
                      : ''
                  } w-[2px] h-[35px] border-[1px] dark:border-gray-500 border-gray-300 mx-[10px]  duration-50`}
                ></motion.div>
                {/* Label */}
                {labels.map((label, index) => (
                  <motion.div
                    ...
                    className='flex flex-col items-center justify-center duration-50'
                  >
                    <div
                          ...
                          className={` ${
                            currentIndex === index + Tools.length
                              ? currentlyDragging &&
                                ...
                                : 'w-[30px] h-[30px]'
                              : 'w-[20px] h-[20px]  '
                          } cursor-grab rounded-full text-gray-500 dark:text-white duration-300  `}
                        >
                          <motion.img
                ...
                <motion.div
                  ...
                  className={`${
                    hasEntered === 0
                      ? 'animate__animated animate__fadeInUp'
                      : ''
                  } duration-50 w-[2px] h-[35px] border-[1px] dark:border-gray-500 border-gray-300 mx-[10px]  duration-50`}
                ></motion.div>
                {/* Current */}
                      ...
                      ${
                        hasEntered
                          ...
                          : 'bg-gray-900/10  dark:bg-gray-100/5'
                            ...
                            >
                              <motion.div>{CurrentTool.svg}</motion.div>
                            </motion.div>
                          </div>
