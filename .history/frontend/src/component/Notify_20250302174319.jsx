...
const NodeQueryPanel = () => {
  ...
  return (
    open && (
      ...
      >
        <div className='w-[600px] animate__animated overflow-hidden animate__fadeInUp max-h-[80%] rounded-[28px] bg-gray-300/50 dark:bg-gray-700/50  px-[40px] py-[50px] transition-all'>
