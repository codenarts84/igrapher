    ...
    open && (
      ...
      >
        <div className='w-[600px] animate__animated overflow-hidden animate__fadeInUp max-h-[80%] rounded-[28px] bg-gray-300/50 dark:bg-gray-600/50  px-[40px] py-[50px] transition-all'>
          <h1 className='mb-[30px] text-[35px] font-black text-center font-medium font-center text-gray-900 dark:text-white animate__animated animate__zoomIn transition-all'>
            Notify
          </h1>
