...
const GraphCanvas = () => {
  ...
  useEffect(() => {
    const fetchGraphData = () => {
      ...
      // const labelColorMapping = mapColors(newNodes, 'label').labelColorMapping;
      // const linkColorMapping = mapColors(newLinks, 'link').linkColorMapping;
      setWholeLabelColorMapping(newNodes);
      setWholeLinkColorMapping(newLinks);
      setDataLoaded(true);
