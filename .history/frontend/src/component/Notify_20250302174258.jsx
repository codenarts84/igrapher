...
const NodeQueryPanel = () => {
  ...
  return (
    open && (
      ...
      >
        <div className='w-[600px] animate__animated overflow-hidden animate__fadeInUp max-h-[80%] rounded-[28px] bg-gray-900/50 dark:bg-gray-600/50  px-[40px] py-[50px] transition-all'>
          ...
          <p className='text-white my-[15px] text-[17px] animate__animated animate__fadeInUp'>
            Welcome to this app! This is a demo version, and some features are
            unavailable because there is no server. The full source code is
            inside the BoxFrame.
          </p>
          <p className='text-white my-[15px] text-[17px] animate__animated animate__fadeInUp'>
            In this project, I was responsible for UI/UX design, animations, and
            frontend development. Additionally, I worked on backend data
